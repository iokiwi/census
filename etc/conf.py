...
_proc_name = os.environ.get("GUNICORN_PROC_NAME", "census")
if _proc_name:
...
_timeout = os.environ.get("GUNICORN_TIMEOUT", 60)
if _timeout:
    timeout = int(_timeout)

# Timeout for graceful workers restart.
# http://docs.gunicorn.org/en/stable/settings.html#graceful-timeout
_graceful_timeout = os.environ.get("GUNICORN_GRACEFUL_TIMEOUT", 60)
